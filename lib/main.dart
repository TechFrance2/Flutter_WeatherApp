...
import 'package:flutter_weatherapp/WeatherBloc.dart';
import 'package:flutter_weatherapp/WeatherModel.dart';
import 'package:flutter_weatherapp/WeatherRepo.dart';
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Center(
          child: Container(
            child: FlareActor(
              "assets/forked_world_spin.flr", fit: BoxFit.contain, animation: "roll",),
            height: 300,
            width: 300,
          )
        ),
          ...
          builder: (context, state) {
            if (state is WeatherIsNotSearched)
              return Container(
                ...
                child: Column(
                  children: <Widget>[
                    Text("Search Weather", style: TextStyle(fontSize: 40,
                        fontWeight: FontWeight.w500,
                        color: Colors.white70),),
                    Text("Instantly", style: TextStyle(fontSize: 40,
